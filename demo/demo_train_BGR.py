...
train_json_path = '../../../Datasets/'+dataset+'/train/thermal_RGBT_pairs_3_class.json'#thermal_annotations_3_channel_no_dogs.json'
...
val_json_path = '../../../Datasets/'+dataset+'/val/thermal_RGBT_pairs_3_class.json'#thermal_annotations_3_channel_no_dogs.json'
