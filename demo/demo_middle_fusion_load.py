...
out_folder = 'output_mid_fusion_max_pooling_cont'
...
cnt = 0
start_iter = 35000
start_count = start_iter // eval_every_iter + 1
load_folder = 'output_mid_fusion_max_pooling/'
#cfg.MODEL.WEIGHTS = load_folder + 'out_model_iter_'+str(start_iter)+'.pth'
out_model_path = load_folder+'/out_model_iter_'+str(start_iter)+'.pth'

for idx in range(start_count,num_loops):
