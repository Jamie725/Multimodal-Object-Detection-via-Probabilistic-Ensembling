...
out_folder = '0304/output_thermal_only_gNLL'
...
cfg.MODEL.PIXEL_MEAN = [135.438, 135.438, 135.438]#[103.530, 116.280, 123.675]
cfg.MODEL.PIXEL_STD = [1.0, 1.0, 1.0]
cfg.MODEL.WEIGHTS = 'good_model/3_class/thermal_only/out_model_thermal_only_gnll_78_45.pth'#'pretrained_model/model_final_f6e8b1.pkl'#"detectron2://COCO-Detection/faster_rcnn_R_101_FPN_3x/137851257/model_final_f6e8b1.pkl"
#########################################
...
for idx in range(num_loops):
    ...
    if idx > 0:
        ...
        out_name = 'out_model_iter_'+ str((idx+1)*eval_every_iter) +'.pth'
    ...
    if AP50 > best_AP50:
        best_AP50 = AP50
        out_model_path = os.path.join(out_folder, 'out_model_thermal_only_best.pth')
        torch.save(trainer.model.state_dict(), out_model_path)
    
    out_model_path = os.path.join(out_folder, 'out_thermal_only_gnll.pth')
    torch.save(trainer.model.state_dict(), out_model_path)
    cfg.MODEL.WEIGHTS = out_model_path
    del trainer
