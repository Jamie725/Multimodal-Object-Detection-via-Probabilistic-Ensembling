...
out_folder = 'out_training/KAIST_flow_UVM_scale_4_no_shift_0525/'
...
cfg.INPUT.FORMAT = 'UVM'#'BGR'
cfg.INPUT.NUM_IN_CHANNELS = 3
scale = 4/3
cfg.MODEL.PIXEL_MEAN = [11.2318*scale, 7.2777*scale, 14.8328*scale]#[225.328, 226.723, 235.070]#[103.530, 116.280, 123.675]
