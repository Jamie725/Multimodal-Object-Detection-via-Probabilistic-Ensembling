...
param_all = list(model_ther.parameters())
param_all[16] = param_cat
...
cfg.MODEL.WEIGHTS = "detectron2://COCO-Detection/faster_rcnn_R_101_FPN_3x/137851257/model_final_f6e8b1.pkl"
cfg.MODEL.WEIGHTS = 'output_6_channel/out_model/out_model_iter_26000.pth'
...
"""
with torch.no_grad():
    trainer.model.weight = param_all
