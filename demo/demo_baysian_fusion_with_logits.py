...
def nms_2(dets, scores, classes, thresh, method):
        ...
        if len(info_1['bbox']) == 0 or len(info_2['bbox']) == 0:
            ...
            if method == 'nms':            
              ...
              or method == 'baysian_wt_score_box':
                threshold = 0.5
                in_boxes, in_scores, in_class, in_logits = prepare_data(info_1, info_2)
...
if __name__ == '__main__':
    ...
    method = 'baysian'#'sumLogits_softmax'#'sumLogits'#'avgLogits_softmax'#'baysian_avg_bbox'#'avg_score'#'pooling' #'baysian'#'nms'
