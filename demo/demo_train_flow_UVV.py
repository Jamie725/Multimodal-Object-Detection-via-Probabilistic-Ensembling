...
dataset = 'KAIST'
# Train path
#train_folder = '../../../Datasets/KAIST/train/'
...
cfg.INPUT.FORMAT = 'UVV'#'BGR'
cfg.INPUT.NUM_IN_CHANNELS = 3
scale = 4/3
cfg.MODEL.PIXEL_MEAN = [11.2318*scale, 7.2777*scale, 14.8328*scale]

#cfg.MODEL.PIXEL_MEAN = [0.28809*scale, 0.47052*scale, 0.47052*scale]#[225.328, 226.723, 235.070]#[103.530, 116.280, 123.675]
