...
out_folder = 'output_early_fusion_test_0615'
...
###### Parameter for early fusion ######
cfg.MODEL.WEIGHTS = 'good_model/thermal_only/out_model_iter_15000.pth' # thermal only
...
# Update conv1 parameters for thermal channel
with torch.no_grad(): 
