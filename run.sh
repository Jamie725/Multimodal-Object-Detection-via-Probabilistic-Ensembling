...
python demo/demo_train_RGBT_sum.py  | tee logs/train_early_fusion_random_crop_lr_0_005_50000_iter.log
...
#python3 demo/demo_middle_fusion.py  > logs/train_mid_fusion_random_crop_50000_iter.log 
#python3 demo/demo_middle_fusion_load.py > logs/train_mid_fusion_freeze_first_max_iter_70000.log 
